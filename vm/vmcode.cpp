...
namespace
  ...
  uint8_t get_modrm_byte_with_digit(const vmcode::operand& target, uint8_t& rex, uint8_t digit, uint64_t target_offset)
    {
    uint8_t mod = 0;
    uint8_t reg = digit;
    uint8_t rm = 0;
    ...
    switch (target)
      ...
      case vmcode::XMM0:
      case vmcode::AL:
      case vmcode::RAX: mod = 3; rm = 0;  break;
      case vmcode::XMM1:
      case vmcode::CL:
      case vmcode::RCX: mod = 3; rm = 1;  break;
      case vmcode::XMM2:
      case vmcode::DL:
      case vmcode::RDX: mod = 3; rm = 2;  break;
      case vmcode::XMM3:
      case vmcode::BL:
      case vmcode::RBX: mod = 3; rm = 3;  break;
      case vmcode::XMM4:
      case vmcode::AH:
      case vmcode::RSP: mod = 3; rm = 4;  break;
      case vmcode::XMM5:
      case vmcode::CH:
      case vmcode::RBP: mod = 3; rm = 5;  break;
      case vmcode::XMM6:
      case vmcode::DH:
      case vmcode::RSI: mod = 3; rm = 6;  break;
      case vmcode::XMM7:
      case vmcode::BH:
      case vmcode::RDI: mod = 3; rm = 7;  break;
      case vmcode::XMM8:
      case vmcode::R8: mod = 3; rm = 0; add_rex_b(rex); break;
      case vmcode::XMM9:
      case vmcode::R9: mod = 3; rm = 1; add_rex_b(rex); break;
      case vmcode::XMM10:
      case vmcode::R10: mod = 3; rm = 2; add_rex_b(rex); break;
      case vmcode::XMM11:
      case vmcode::R11: mod = 3; rm = 3; add_rex_b(rex); break;
      case vmcode::XMM12:
      case vmcode::R12: mod = 3; rm = 4; add_rex_b(rex); break;
      case vmcode::XMM13:
      case vmcode::R13: mod = 3; rm = 5; add_rex_b(rex); break;
      case vmcode::XMM14:
      case vmcode::R14: mod = 3; rm = 6; add_rex_b(rex); break;
      case vmcode::XMM15:
      case vmcode::R15: mod = 3; rm = 7; add_rex_b(rex); break;
      case vmcode::MEM_RAX: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 0; break;
      case vmcode::MEM_RCX: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 1; break;
      case vmcode::MEM_RDX: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 2; break;
      case vmcode::MEM_RBX: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 3; break;
      case vmcode::MEM_RSP: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 4; break;
      case vmcode::MEM_RBP: mod = zero ? 1 : (eight_bit ? 1 : 2); rm = 5; break; // rbp is exception for zero offset
      case vmcode::MEM_RSI: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 6; break;
      case vmcode::MEM_RDI: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 7; break;
      case vmcode::MEM_R8: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 0; add_rex_b(rex); break;
      case vmcode::MEM_R9: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 1; add_rex_b(rex); break;
      case vmcode::MEM_R10: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 2; add_rex_b(rex); break;
      case vmcode::MEM_R11: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 3; add_rex_b(rex); break;
      case vmcode::MEM_R12: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 4; add_rex_b(rex); break;
      case vmcode::MEM_R13: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 5; add_rex_b(rex); break;
      case vmcode::MEM_R14: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 6; add_rex_b(rex); break;
      case vmcode::MEM_R15: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 7; add_rex_b(rex); break;

        // not tested very well, bugs possible
      case vmcode::BYTE_MEM_RAX: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 0; break;
      case vmcode::BYTE_MEM_RCX: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 1; break;
      case vmcode::BYTE_MEM_RDX: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 2; break;
      case vmcode::BYTE_MEM_RBX: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 3; break;
      case vmcode::BYTE_MEM_RSP: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 4; break;
      case vmcode::BYTE_MEM_RBP: mod = zero ? 1 : (eight_bit ? 1 : 2); rm = 5; break; // rbp is exception for zero offset
      case vmcode::BYTE_MEM_RSI: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 6; break;
      case vmcode::BYTE_MEM_RDI: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 7; break;
      case vmcode::BYTE_MEM_R8: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 0; add_rex_b(rex); break;
      case vmcode::BYTE_MEM_R9: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 1; add_rex_b(rex); break;
      case vmcode::BYTE_MEM_R10: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 2; add_rex_b(rex); break;
      case vmcode::BYTE_MEM_R11: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 3; add_rex_b(rex); break;
      case vmcode::BYTE_MEM_R12: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 4; add_rex_b(rex); break;
      case vmcode::BYTE_MEM_R13: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 5; add_rex_b(rex); break;
      case vmcode::BYTE_MEM_R14: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 6; add_rex_b(rex); break;
      case vmcode::BYTE_MEM_R15: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 7; add_rex_b(rex); break;
      default: throw std::logic_error("get_modrm_byte: not implemented");
      }
    return make_modrm_byte(mod, reg, rm);
    }

  uint8_t get_modrm_byte(const vmcode::operand& target, const vmcode::operand& source, uint8_t& rex, uint64_t target_offset)
    {
    uint8_t mod = 0;
    uint8_t reg = 0;
    uint8_t rm = 0;
    ...
    switch (target)
      ...
      case vmcode::MEM_R11: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 3; add_rex_b(rex); break;
      case vmcode::MEM_R12: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 4; add_rex_b(rex); break;
      case vmcode::MEM_R13: mod = zero ? 1 : (eight_bit ? 1 : 2); rm = 5; add_rex_b(rex); break; // r13 is exception for zero offset
      case vmcode::MEM_R14: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 6; add_rex_b(rex); break;
      case vmcode::MEM_R15: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 7; add_rex_b(rex); break;
      ...
      case vmcode::BYTE_MEM_R11: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 3; add_rex_b(rex); break;
      case vmcode::BYTE_MEM_R12: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 4; add_rex_b(rex); break;
      case vmcode::BYTE_MEM_R13: mod = zero ? 1 : (eight_bit ? 1 : 2); rm = 5; add_rex_b(rex); break; // r13 is exception for zero offset
      case vmcode::BYTE_MEM_R14: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 6; add_rex_b(rex); break;
      case vmcode::BYTE_MEM_R15: mod = zero ? 0 : (eight_bit ? 1 : 2); rm = 7; add_rex_b(rex); break;
      default: throw std::logic_error("get_modrm_byte: not implemented");
      }
    switch (source)
      ...
      case vmcode::AL:
      case vmcode::XMM0:
      case vmcode::RAX: reg = 0;  break;
      case vmcode::XMM1:
      case vmcode::CL:
      case vmcode::RCX: reg = 1;  break;
      case vmcode::XMM2:
      case vmcode::DL:
      case vmcode::RDX: reg = 2;  break;
      case vmcode::XMM3:
      case vmcode::BL:
      case vmcode::RBX: reg = 3;  break;
      case vmcode::XMM4:
      case vmcode::AH:
      case vmcode::RSP: reg = 4;  break;
      case vmcode::XMM5:
      case vmcode::CH:
      case vmcode::RBP: reg = 5;  break;
      case vmcode::XMM6:
      case vmcode::DH:
      case vmcode::RSI: reg = 6;  break;
      case vmcode::XMM7:
      case vmcode::BH:
      case vmcode::RDI: reg = 7;  break;
      case vmcode::XMM8:
      case vmcode::R8: add_rex_r(rex); reg = 0; break;
      case vmcode::XMM9:
      case vmcode::R9: add_rex_r(rex); reg = 1; break;
      case vmcode::XMM10:
      case vmcode::R10: add_rex_r(rex); reg = 2; break;
      case vmcode::XMM11:
      case vmcode::R11: add_rex_r(rex); reg = 3; break;
      case vmcode::XMM12:
      case vmcode::R12: add_rex_r(rex); reg = 4; break;
      case vmcode::XMM13:
      case vmcode::R13: add_rex_r(rex); reg = 5; break;
      case vmcode::XMM14:
      case vmcode::R14: add_rex_r(rex); reg = 6; break;
      case vmcode::XMM15:
      case vmcode::R15: add_rex_r(rex); reg = 7; break;
      default: throw std::logic_error("get_modrm_byte: not implemented");
      }
    return make_modrm_byte(mod, reg, rm);
    }

  void add_register_to_opcode(uint8_t& rex, uint8_t& opcode, const vmcode::operand& op)
    {
    switch (op)
      {
      case vmcode::AL: break;
      case vmcode::RAX: break;
      case vmcode::CL:
      case vmcode::RCX: opcode |= 1; break;
      case vmcode::BL:
      case vmcode::RDX: opcode |= 2; break;
      case vmcode::DL:
      case vmcode::RBX: opcode |= 3; break;
      case vmcode::AH:
      case vmcode::RSP: opcode |= 4; break;
      case vmcode::CH:
      case vmcode::RBP: opcode |= 5; break;
      case vmcode::DH:
      case vmcode::RSI: opcode |= 6; break;
      case vmcode::BH:
      case vmcode::RDI: opcode |= 7; break;
      case vmcode::R8: add_rex_b(rex); break;
      case vmcode::R9: add_rex_b(rex); opcode |= 1; break;
      case vmcode::R10: add_rex_b(rex); opcode |= 2; break;
      case vmcode::R11: add_rex_b(rex); opcode |= 3; break;
      case vmcode::R12: add_rex_b(rex); opcode |= 4; break;
      case vmcode::R13: add_rex_b(rex); opcode |= 5; break;
      case vmcode::R14: add_rex_b(rex); opcode |= 6; break;
      case vmcode::R15: add_rex_b(rex); opcode |= 7; break;
  ...
  opcode::opcode_operand_type get_opcode_operand_type(const vmcode::operand& op, uint64_t nr)
    {
    switch (op)
      {
      case vmcode::EMPTY: return opcode::none;
      case vmcode::AL: return opcode::al;
      case vmcode::AH: return opcode::r8;
      case vmcode::BL: return opcode::r8;
      case vmcode::BH: return opcode::r8;
      case vmcode::CL: return opcode::cl;
      case vmcode::CH: return opcode::r8;
      case vmcode::DL: return opcode::r8;
      case vmcode::DH: return opcode::r8;      
      case vmcode::RAX: return opcode::rax;
      case vmcode::RBX: return opcode::r64;
      case vmcode::RCX: return opcode::r64;
      case vmcode::RDX: return opcode::r64;
      case vmcode::RDI: return opcode::r64;
      case vmcode::RSI: return opcode::r64;
      case vmcode::RSP: return opcode::r64;
      case vmcode::RBP: return opcode::r64;
      case vmcode::R8:  return opcode::r64;
      case vmcode::R9:  return opcode::r64;
      case vmcode::R10: return opcode::r64;
      case vmcode::R11: return opcode::r64;
      case vmcode::R12: return opcode::r64;
      case vmcode::R13: return opcode::r64;
      case vmcode::R14: return opcode::r64;
      case vmcode::R15: return opcode::r64;     
      case vmcode::MEM_RAX: return opcode::m64;
      case vmcode::MEM_RBX: return opcode::m64;
      case vmcode::MEM_RCX: return opcode::m64;
      case vmcode::MEM_RDX: return opcode::m64;
      case vmcode::MEM_RDI: return opcode::m64;
      case vmcode::MEM_RSI: return opcode::m64;
      case vmcode::MEM_RSP: return opcode::m64;
      case vmcode::MEM_RBP: return opcode::m64;
      case vmcode::MEM_R8:  return opcode::m64;
      case vmcode::MEM_R9:  return opcode::m64;
      case vmcode::MEM_R10: return opcode::m64;
      case vmcode::MEM_R11: return opcode::m64;
      case vmcode::MEM_R12: return opcode::m64;
      case vmcode::MEM_R13: return opcode::m64;
      case vmcode::MEM_R14: return opcode::m64;
      case vmcode::MEM_R15: return opcode::m64;
      case vmcode::BYTE_MEM_RAX: return opcode::m8;
      case vmcode::BYTE_MEM_RBX: return opcode::m8;
      case vmcode::BYTE_MEM_RCX: return opcode::m8;
      case vmcode::BYTE_MEM_RDX: return opcode::m8;
      case vmcode::BYTE_MEM_RDI: return opcode::m8;
      case vmcode::BYTE_MEM_RSI: return opcode::m8;
      case vmcode::BYTE_MEM_RSP: return opcode::m8;
      case vmcode::BYTE_MEM_RBP: return opcode::m8;
      case vmcode::BYTE_MEM_R8:  return opcode::m8;
      case vmcode::BYTE_MEM_R9:  return opcode::m8;
      case vmcode::BYTE_MEM_R10: return opcode::m8;
      case vmcode::BYTE_MEM_R11: return opcode::m8;
      case vmcode::BYTE_MEM_R12: return opcode::m8;
      case vmcode::BYTE_MEM_R13: return opcode::m8;
      case vmcode::BYTE_MEM_R14: return opcode::m8;
      case vmcode::BYTE_MEM_R15: return opcode::m8;    
      case vmcode::NUMBER:
      {
      if (is_8_bit(nr))
        return opcode::imm8;
      ...
      case vmcode::ST0:  return opcode::st0;
      case vmcode::ST1:  return opcode::sti;
      case vmcode::ST2:  return opcode::sti;
      case vmcode::ST3:  return opcode::sti;
      case vmcode::ST4:  return opcode::sti;
      case vmcode::ST5:  return opcode::sti;
      case vmcode::ST6:  return opcode::sti;
      case vmcode::ST7:  return opcode::sti;
      case vmcode::XMM0: return opcode::xmm;
      case vmcode::XMM1: return opcode::xmm;
      case vmcode::XMM2: return opcode::xmm;
      case vmcode::XMM3: return opcode::xmm;
      case vmcode::XMM4: return opcode::xmm;
      case vmcode::XMM5: return opcode::xmm;
      case vmcode::XMM6: return opcode::xmm;
      case vmcode::XMM7: return opcode::xmm;
      case vmcode::XMM8: return opcode::xmm;
      case vmcode::XMM9: return opcode::xmm;
      case vmcode::XMM10: return opcode::xmm;
      case vmcode::XMM11: return opcode::xmm;
      case vmcode::XMM12: return opcode::xmm;
      case vmcode::XMM13: return opcode::xmm;
      case vmcode::XMM14: return opcode::xmm;
      case vmcode::XMM15: return opcode::xmm; 
      case vmcode::LABELADDRESS: return opcode::imm64;
      }
    return opcode::none;
    }

  uint64_t fill_default(uint8_t* opcode_stream, vmcode::instruction code, opcode o, opcode::opcode_operand_type op1d, opcode::opcode_operand_type op2d)
    {    
    ...
    if (o.flags & opcode::r)
      ...
      else if (code.operand2 != vmcode::operand::EMPTY)
    ...
    if (use_modrm)
      {
      //if (code.operand1 == vmcode::MEM_RSP || code.operand2 == vmcode::MEM_RSP || code.operand1 == vmcode::BYTE_MEM_RSP || code.operand2 == vmcode::BYTE_MEM_RSP) // sib necessary
    ...
    if (o.opcode_id_2)
      ...
      if (o.operand_1 == opcode::sti)
        {
        uint8_t i = (uint8_t)(code.operand1 - vmcode::ST0);
        push1byte(stream, o.opcode_id_2 + i);
        }
      else if (o.operand_2 == opcode::sti)
        {
        uint8_t i = (uint8_t)(code.operand2 - vmcode::ST0);
        push1byte(stream, o.opcode_id_2 + i);
        }
      else
    ...
    if (is_memory_operand_type(op1d))
      {
      if (code.operand1_mem || code.operand1 == vmcode::MEM_RBP || code.operand1 == vmcode::MEM_R13 || code.operand1 == vmcode::BYTE_MEM_RBP || code.operand1 == vmcode::BYTE_MEM_R13) // [rbp] and [r13] are exception 
        {
    ...
    if (is_immediate_operand_type(op2d))
      ...
      {
      if (code.operand2_mem || code.operand2 == vmcode::MEM_RBP || code.operand2 == vmcode::MEM_R13 || code.operand2 == vmcode::BYTE_MEM_RBP || code.operand2 == vmcode::BYTE_MEM_R13) // [rbp] and [r13] are exception 
        {
  ...
  uint64_t fill(uint8_t* opcode_stream, const vmcode::instruction& code, const opcode_table& table)
    {
...
uint64_t vmcode::instruction::fill_opcode(uint8_t* opcode_stream) const
  {
  switch (oper)
    {
    case vmcode::ADD: return fill(opcode_stream, *this, g_table.find("ADD")->second);
    case vmcode::ADDSD: return fill(opcode_stream, *this, g_table.find("ADDSD")->second);
    case vmcode::AND: return fill(opcode_stream, *this, g_table.find("AND")->second);
    case vmcode::CALLEXTERNAL:
    case vmcode::CALL: return fill(opcode_stream, *this, g_table.find("CALL")->second);    
    case vmcode::COMMENT: return 0;
    case vmcode::CMP: return fill(opcode_stream, *this, g_table.find("CMP")->second);
    case vmcode::CMPEQPD: return fill(opcode_stream, *this, g_table.find("CMPEQPD")->second);
    case vmcode::CMPLTPD: return fill(opcode_stream, *this, g_table.find("CMPLTPD")->second);
    case vmcode::CMPLEPD: return fill(opcode_stream, *this, g_table.find("CMPLEPD")->second);
    case vmcode::CQO: return fill(opcode_stream, *this, g_table.find("CQO")->second);
    case vmcode::CVTSI2SD: return fill(opcode_stream, *this, g_table.find("CVTSI2SD")->second);    
    case vmcode::CVTTSD2SI: return fill(opcode_stream, *this, g_table.find("CVTTSD2SI")->second);
    case vmcode::DEC: return fill(opcode_stream, *this, g_table.find("DEC")->second);
    case vmcode::DIV: return fill(opcode_stream, *this, g_table.find("DIV")->second);
    case vmcode::DIVSD: return fill(opcode_stream, *this, g_table.find("DIVSD")->second);
    case vmcode::EXTERN: return 0;
    case vmcode::F2XM1: return fill(opcode_stream, *this, g_table.find("F2XM1")->second);
    case vmcode::FADD: return fill(opcode_stream, *this, g_table.find("FADD")->second);   
    case vmcode::FADDP: return fill(opcode_stream, *this, g_table.find("FADDP")->second);
    case vmcode::FISTPQ: return fill(opcode_stream, *this, g_table.find("FISTP")->second);   
    case vmcode::FILD: return fill(opcode_stream, *this, g_table.find("FILD")->second);
    case vmcode::FLD: return fill(opcode_stream, *this, g_table.find("FLD")->second);
    case vmcode::FLD1: return fill(opcode_stream, *this, g_table.find("FLD1")->second);   
    case vmcode::FLDPI: return fill(opcode_stream, *this, g_table.find("FLDPI")->second);
    case vmcode::FLDLN2: return fill(opcode_stream, *this, g_table.find("FLDLN2")->second);   
    case vmcode::FMUL: return fill(opcode_stream, *this, g_table.find("FMUL")->second);
    case vmcode::FSIN: return fill(opcode_stream, *this, g_table.find("FSIN")->second);
    case vmcode::FCOS: return fill(opcode_stream, *this, g_table.find("FCOS")->second);
    case vmcode::FPATAN: return fill(opcode_stream, *this, g_table.find("FPATAN")->second);  
    case vmcode::FPTAN: return fill(opcode_stream, *this, g_table.find("FPTAN")->second);
    case vmcode::FRNDINT: return fill(opcode_stream, *this, g_table.find("FRNDINT")->second);
    case vmcode::FSCALE: return fill(opcode_stream, *this, g_table.find("FSCALE")->second);
    case vmcode::FSQRT: return fill(opcode_stream, *this, g_table.find("FSQRT")->second);
    case vmcode::FSTP: return fill(opcode_stream, *this, g_table.find("FSTP")->second);    
    case vmcode::FSUB: return fill(opcode_stream, *this, g_table.find("FSUB")->second);   
    case vmcode::FSUBP: return fill(opcode_stream, *this, g_table.find("FSUBP")->second);
    case vmcode::FSUBRP: return fill(opcode_stream, *this, g_table.find("FSUBRP")->second);
    case vmcode::FXCH: return fill(opcode_stream, *this, g_table.find("FXCH")->second);
    case vmcode::FYL2X: return fill(opcode_stream, *this, g_table.find("FYL2X")->second);
    case vmcode::GLOBAL: return 0;
    case vmcode::LABEL: return 0;

    case vmcode::LABEL_ALIGNED: return 0;
    case vmcode::IDIV: return fill(opcode_stream, *this, g_table.find("IDIV")->second);
    case vmcode::IMUL: return fill(opcode_stream, *this, g_table.find("IMUL")->second);
    case vmcode::INC: return fill(opcode_stream, *this, g_table.find("INC")->second);
    case vmcode::JE: return fill(opcode_stream, *this, g_table.find("JE")->second);
    case vmcode::JL: return fill(opcode_stream, *this, g_table.find("JL")->second);
    case vmcode::JLE: return fill(opcode_stream, *this, g_table.find("JLE")->second);
    case vmcode::JA: return fill(opcode_stream, *this, g_table.find("JA")->second);
    case vmcode::JB: return fill(opcode_stream, *this, g_table.find("JB")->second);
    case vmcode::JG: return fill(opcode_stream, *this, g_table.find("JG")->second);
    case vmcode::JGE: return fill(opcode_stream, *this, g_table.find("JGE")->second);
    case vmcode::JNE: return fill(opcode_stream, *this, g_table.find("JNE")->second);
    case vmcode::JMP: return fill(opcode_stream, *this, g_table.find("JMP")->second);
    case vmcode::JES: return fill(opcode_stream, *this, g_table.find("JES")->second);
    case vmcode::JLS: return fill(opcode_stream, *this, g_table.find("JLS")->second);
    case vmcode::JLES: return fill(opcode_stream, *this, g_table.find("JLES")->second);
    case vmcode::JAS: return fill(opcode_stream, *this, g_table.find("JAS")->second);
    case vmcode::JBS: return fill(opcode_stream, *this, g_table.find("JBS")->second);
    case vmcode::JGS: return fill(opcode_stream, *this, g_table.find("JGS")->second);
    case vmcode::JGES: return fill(opcode_stream, *this, g_table.find("JGES")->second);
    case vmcode::JNES: return fill(opcode_stream, *this, g_table.find("JNES")->second);
    case vmcode::JMPS: return fill(opcode_stream, *this, g_table.find("JMPS")->second); 
    case vmcode::MOV: return fill(opcode_stream, *this, g_table.find("MOV")->second);   
    case vmcode::MOVQ: return fill(opcode_stream, *this, g_table.find("MOVQ")->second);   
    case vmcode::MOVMSKPD: return fill(opcode_stream, *this, g_table.find("MOVMSKPD")->second);   
    case vmcode::MOVSD: return fill(opcode_stream, *this, g_table.find("MOVSD")->second);
    case vmcode::MOVZX: return fill(opcode_stream, *this, g_table.find("MOVZX")->second);
    case vmcode::MUL: return fill(opcode_stream, *this, g_table.find("MUL")->second);
    case vmcode::MULSD: return fill(opcode_stream, *this, g_table.find("MULSD")->second);   
    case vmcode::NEG: return fill(opcode_stream, *this, g_table.find("NEG")->second);
    case vmcode::NOP: return fill(opcode_stream, *this, g_table.find("NOP")->second);
    case vmcode::OR: return fill(opcode_stream, *this, g_table.find("OR")->second);
    case vmcode::POP: return fill(opcode_stream, *this, g_table.find("POP")->second);
    case vmcode::PUSH: return fill(opcode_stream, *this, g_table.find("PUSH")->second);
    case vmcode::RET: return fill(opcode_stream, *this, g_table.find("RET")->second);   
    case vmcode::SAL: return fill(opcode_stream, *this, g_table.find("SAL")->second);
    case vmcode::SAR: return fill(opcode_stream, *this, g_table.find("SAR")->second);
    case vmcode::SETE: return fill(opcode_stream, *this, g_table.find("SETE")->second);
    case vmcode::SETNE: return fill(opcode_stream, *this, g_table.find("SETNE")->second);
    case vmcode::SETL: return fill(opcode_stream, *this, g_table.find("SETL")->second);
    case vmcode::SETG: return fill(opcode_stream, *this, g_table.find("SETG")->second);
    case vmcode::SETLE: return fill(opcode_stream, *this, g_table.find("SETLE")->second);
    case vmcode::SETGE: return fill(opcode_stream, *this, g_table.find("SETGE")->second);
    case vmcode::SHL: return fill(opcode_stream, *this, g_table.find("SHL")->second);  
    case vmcode::SHR: return fill(opcode_stream, *this, g_table.find("SHR")->second);
    case vmcode::SQRTPD: return fill(opcode_stream, *this, g_table.find("SQRTPD")->second); 
    case vmcode::SUB: return fill(opcode_stream, *this, g_table.find("SUB")->second);
    case vmcode::SUBSD: return fill(opcode_stream, *this, g_table.find("SUBSD")->second);    
    case vmcode::TEST: return fill(opcode_stream, *this, g_table.find("TEST")->second);
    case vmcode::UCOMISD: return fill(opcode_stream, *this, g_table.find("UCOMISD")->second);    
    case vmcode::XOR: return fill(opcode_stream, *this, g_table.find("XOR")->second);
    case vmcode::XORPD: return fill(opcode_stream, *this, g_table.find("XORPD")->second);
